...
const getProfissionalById = async (req, res) => {
  try {
    const profissional = await profissionalModel.getProfissionalById(
      req.params.id
    );
    if (!profissional) {
...
const updateProfissional = async (req, res) => {
  try {
    ...
    const updatedProfissional = await profissionalModel.updateProfissional(
      req.params.id,
      {
        nome,
        idade: idadeValidada,
        ...
        foto,
        pais,
        categoria_id: categoriaValidada,
      }
    );
